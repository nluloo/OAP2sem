...
int elements_tree(Tree* Root, int data) {
    int count = 0;

    if (Root != nullptr) {
        count += elements_tree(Root->right, data);
        count += elements_tree(Root->left, data);
...
void menu() {
    ...
    cout << "4. Количество элементо с введенным значением" << endl;
}
...
int main() {
    ...
    do {
        ...
        case 3:
            ...
            break;
        case 4:
            cout << "Введиое значение: ";
            cin >> data;
            cout << "Количество элементов с данным значением: " << elements_tree(Root, data ) << endl;
            break;
        default:
            break;
        }
