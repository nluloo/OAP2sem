...
void menu() {
	...
	cout << "7.Сумма отрицательных элементов, кратных 5" << endl;
}
...
void toFile(list*& p) {
	list* temp = p;
	list buff;
	ofstream writeFile("D:\\labs\\oap1.2\\lab6files\\FILE1.txt");
	while(temp) {
		buff = *temp;
...
void fromFile(list*& p) {
	list* first = NULL;
	ifstream readFile("D:\\labs\\oap1.2\\lab6files\\FILE1.txt");
